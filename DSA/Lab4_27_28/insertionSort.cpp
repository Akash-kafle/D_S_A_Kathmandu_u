...
int main()
{
    ...
    std::cout << "Insertion Sort Performance" << std::endl;
...
void measurePerformance(int sampleSize, std::vector<std::tuple<int, double, double, double, double>> &durations)
{
    ...
    double worst = 0, average = 0, best = 0, duplicates = 0;
    ...
    durations.emplace_back(sampleSize, worst, average, best, duplicates);
}
